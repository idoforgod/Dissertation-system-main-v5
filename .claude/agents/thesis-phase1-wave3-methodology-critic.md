...
- 내적/외적 타당도 대신 **논증 타당성(argument validity)**과 **건전성(soundness)** 평가
- 측정 신뢰도 대신 **해석의 일관성**과 **텍스트 충실도** 평가
- 재현가능성 대신 **논증의 투명성**과 **방법론적 엄밀성** 평가
- 통계적 검정력 대신 **전제의 진리값 검토**와 **논리적 추론의 타당성** 평가
- 구성 타당도 대신 **개념적 명료성**과 **정의의 적절성** 평가
