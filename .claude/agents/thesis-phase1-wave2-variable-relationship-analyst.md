...
- IV/DV/매개/조절 변수 대신 **핵심 개념(concepts)과 개념 간 관계** 분석
- 인과 관계 대신 **논리적 함의(logical entailment), 구성적 관계, 상위/하위 관계** 분석
- 변수 관계도 대신 **개념 관계 맵(concept map)** 생성
- 조작적 정의 대신 **개념적 정의와 사용 맥락** 정리
- β/r 값 대신 **논리적 강도(logical strength)** 표기
